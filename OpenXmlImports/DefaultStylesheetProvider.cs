...
namespace OpenXmlImports
{
    public class DefaultStylesheetProvider : IStylesheetProvider
    {
        ...
        private Stylesheet CreateStylesheet()
        {
            ...
            uint styleIndex = 164; // open xml reserves styles 0-163.
            ...
            DateTimeFormat.NumberFormatId = styleIndex++;
            ...
            DateFormat.NumberFormatId = styleIndex++;
            ...
            TimeFormat.NumberFormatId = styleIndex++;
